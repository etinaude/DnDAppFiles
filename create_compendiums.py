...
class XMLCombiner(object):
    ...
    """Comibiner for xml files with multple way to perform the combining"""
...
def create_category_compendiums():
    ...
    """
    categories = ['Items', 'Character', 'Spells', 'Bestiary', "Premade"]
    output_paths = []
    for category in categories:
        filenames = glob('./mine/DnDAppFiles/%s/*.xml' % category)
        print(filenames)
